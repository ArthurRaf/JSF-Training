		...
		<form class="form-style1">
			<div class='content'>
				...
				<table class='table-style fontSize11 table-style2'>
					...
					<tr>
						<td class='td-style'><a href='./Blank.html' class='ico-del1'
							title="Delete"
							onclick="return sis.utils.confirm('Delete anyway?');"></a></td>
						<td class='td-style'><a class='link-style'
							href='./ProjectAddEditForm.html'>Project 1</a></td>
					</tr>
					<tr>
				...
				<button class='button-style2' formaction="./ProjectAddEditForm.html">Add</button>
			</div>
			</form>
			...
			<div class='content'>
				...
				<table class='table-style fontSize11 table-style2'>
					...
					<tr>
						<td class='td-style'>							
							<a class='link-style' href='#' onclick="document.getElementById('currentReportId').value=<%=reportItem.getReportId()%>; document.getElementById('reportsForm').submit();">								
								<%=reportItem.getName()%>															
							</a>
						</td>
						<td class='td-style'>
